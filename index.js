const config = require("./config"); // taro PALING ATAS
...
function getWaktuSalam() {
        ...
        if (hour >= 1 && hour <= 6) {
                ...
                return "Yoru osoi desu ne..🌌";
        } else {
                return "Yoru osoi desu ne.."; // fallback
        }
}
...
bot.action("check_sub", async (ctx) => {
        ...
        try {
                ...
                await ctx.editMessageText(
                        `<blockquote>` +
                                `<b>❌ Gagal Unmute</b>\n` +
                                `Pastikan bot punya izin admin penuh.` +
                                `</blockquote>`,
                        { parse_mode: "HTML" }
                );
        }
...
async function sendMainMenu(ctx) {
        ...
        const caption =
                `<blockquote><b>Moshi moshi, ogenki desu ka? @${ctx.from.username || "user"} 👋 ${waktu} Nani ka otetsudai dekimasu ka? Aa, sōdesu ne, hajimemashite — watashi no namae wa Elika desu. Dragon to iu developer ni yotte kaihatsu saremashita, author janai desu.</b></blockquote>
<blockquote><b>┏━━⧼ ʙᴏᴛ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ⧽
┃ ⚝ ɢᴜɪᴅᴇ    : <a href="https://telegra.ph/Elika-Md-01-29">Elika-Md (Telegraph)</a>
┃ ⚝ ɴᴏᴅᴇ     : v20.20.0
┃ ⚝ ᴍᴇᴍᴏʀʏ   : ${memPanelText}
┃ ⚝ ᴄᴘᴜ      : ${cpuText}
...
┃ ⚝ ᴡɪᴛ : ${wit}
┗━━━━━━━━━━━━━━━━◇</b></blockquote>
<blockquote><b>ᴏᴡɴᴇʀ: @Rizzxtzy</b></blockquote>
<blockquote><b>─╶Ꮺ ᴘʀᴇss ᴛʜᴇ ᴍᴇɴᴜ ʙᴜᴛᴛᴏɴ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴇɴᴜ</b></blockquote>`;
        ...
        await ctx.replyWithPhoto(
                { source: fs.createReadStream("./gambar/banner.png") },
                {
                        ...
                        reply_markup: {
                                inline_keyboard: [
                                        [
                                                { text: "〔 ᴄʜᴀɴɴᴇʟ 〕", url: "https://t.me/ZynDelta" },
...
┃ ✚ ᴛᴏᴛᴀʟ ᴄᴀᴛᴇɢᴏʀʏ : 𝟹𝟶
┣━━━━━━━━━━━━━━━━━━━━━━━❖
┃⚝┌ /islam menu        /saweria menu
┃⚝├ /claim menu        /games menu
┃⚝├ /tebak menu        /catat menu
┃⚝├ /store menu        /jasher menu
┃⚝├ /bypass menu       /install menu
┃⚝├ /download menu     /tools menu
┃⚝├ /group menu        /bot menu
┃⚝├ /search menu       /stalk menu
┃⚝├ /panel menu        /owner menu
┃⚝├ /botmenu menu      /ownerpanel menu
┃⚝├ /developer menu    /web menu
┃⚝├ /vps menu          /subdo menu
┃⚝├ /fun menu          /rpg menu
┃⚝├ /enc menu          /anime menu
┃⚝└ /random menu       /support menu
┗━━━━━━━━━━━━━━━━━━━━━━━━❖</strong></blockquote>
<blockquote><b>─╶ ᴘʀᴇss ᴛʜᴇ ᴍᴇɴᴜ ʙᴜᴛᴛᴏɴ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴇɴᴜ</b></blockquote>`;
...
┗━━━━━━━━━━━━━━━━━━━━━━━━❖</strong></blockquote>`;
        ...
        newCaption =
                `<blockquote><strong>привет, добро пожаловать, позвольте представить себя, я бот-баг, созданный для повреждения WhatsApp цели, используй меня как хочешь, спасибо</strong></blockquote>
